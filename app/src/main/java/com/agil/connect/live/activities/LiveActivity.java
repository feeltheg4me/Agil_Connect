...
import com.agil.connect.MainActivity;
import com.agil.connect.R;
import com.agil.connect.adapter.AdapterLiveChat;
import com.agil.connect.live.stats.LocalStatsData;
import com.agil.connect.live.stats.RemoteStatsData;
import com.agil.connect.live.stats.StatsData;
import com.agil.connect.live.ui.VideoGridContainer;
import com.agil.connect.model.ModelLiveChat;
...
public class LiveActivity extends RtcBaseActivity {
    ...
    private void initUI() {
         ...
         role = getIntent().getIntExtra(
                com.agil.connect.live.Constants.KEY_CLIENT_ROLE,
        ...
        rtcEngine().setBeautyEffectOptions(beautyBtn.isActivated(),
                com.agil.connect.live.Constants.DEFAULT_BEAUTY_OPTIONS);
    ...
    private void initData() {
        mVideoDimension = com.agil.connect.live.Constants.VIDEO_DIMENSIONS[
