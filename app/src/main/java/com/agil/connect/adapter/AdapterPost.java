package com.agil.connect.adapter;
...
import com.agil.connect.Adpref;
import com.agil.connect.R;
import com.agil.connect.activity.CommentActivity;
import com.agil.connect.activity.EditPostActivity;
import com.agil.connect.activity.LikedByActivity;
import com.agil.connect.activity.MediaActivity;
import com.agil.connect.activity.MyProfileActivity;
import com.agil.connect.activity.RetweetedByActivity;
import com.agil.connect.activity.SearchPostActivity;
import com.agil.connect.activity.UserProfileActivity;
import com.agil.connect.model.ModelPost;
import com.agil.connect.model.ModelUser;
import com.agil.connect.notifications.Data;
import com.agil.connect.notifications.Sender;
import com.agil.connect.notifications.Token;
                    ...
                    try {
                        ...
                        JsonObjectRequest jsonObjectRequest = new JsonObjectRequest("https://fcm.googleapis.com/fcm/send", jsonObject, new Response.Listener<JSONObject>() {
                            ...
                            public Map<String, String> getHeaders() throws AuthFailureError {
                                ...
                                headers.put("Authorization", "key=AAAAfcz5ffI:APA91bFu2jJXqGUvP_v8lQ8eVQealPie20H-r406nhStajk1emABX2W9y5oy4uO4_pAL_MXjEyPTYXMfCBPr6JTn1ksuW2YQGUlyLYG75PEEbj792gfs7p_5uLw6pWKgjiRt12RY8vbs");
                                return headers;
                            }
                        };
